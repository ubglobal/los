            ...
            <div class="px-4 h-16 flex justify-between items-center border-b">
                ...
                <div class="flex items-center space-x-4">
                    <div class="text-right">
                         <div class="font-semibold text-gray-800"><?php echo htmlspecialchars($_SESSION['full_name'] ?? 'User'); ?></div>
                         <div class="text-xs text-gray-500"><?php echo htmlspecialchars(($_SESSION['role'] ?? 'N/A') . ' - ' . ($_SESSION['branch'] ?? 'N/A')); ?></div>
                    </div>
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <aside class="w-64 bg-white p-4 flex-shrink-0 overflow-y-auto border-r">
                <nav class="space-y-2">
                    ...
                    <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'CVQHKH'): ?>
